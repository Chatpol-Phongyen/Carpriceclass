...
def features_size(max_power, mileage, km_driven, year):
    if max_power == None:
        max_power = features_max_power_median # Fill in maximum power if dosen't been inserted
    if mileage == None:
        mileage = features_mileage_mean # Fill in mileage if dosen't been inserted
    ...
    return f"Shape of inputs is {sample.reshape(-1, 1).shape}"
...
def output_size(max_power, mileage, km_driven, year):
    if max_power == None:
        max_power = features_max_power_median # Fill in maximum power if dosen't been inserted
    if mileage == None:
        mileage = features_mileage_mean # Fill in mileage if dosen't been inserted
